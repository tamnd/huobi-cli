...
Most of these come down to network reality or how huobi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

huobi rate-limits like any public site. huobi already paces
...
Where a surface is gated, huobi reads a cookie or token you supply
...
`huobi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what huobi actually did
