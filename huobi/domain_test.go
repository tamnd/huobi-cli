...
func TestHostWiring(t *testing.T) {
	...
	if want := "huobi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("huobi", "about")
	if err != nil || got.String() != "huobi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want huobi://page/about", got.String(), err)
	}
}
